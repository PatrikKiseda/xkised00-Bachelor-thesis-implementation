...
class TestGenerationService(unittest.TestCase):
    ...
    def test_litellm_client_uses_default_temperature_for_gpt5_family(self) -> None:
        client = LiteLLMGenerationClient(model="openai/gpt-5.4-mini", api_key="test-key")
    ...
    def test_litellm_client_preserves_temperature_for_non_gpt5_models(self) -> None:
        client = LiteLLMGenerationClient(model="openai/gpt-4o-mini", api_key="test-key")
        mocked_response = {"choices": [{"message": {"content": "Answer"}}]}
        ...
        self.assertEqual(answer, "Answer")
        self.assertEqual(completion.call_args.kwargs["temperature"], 0.1)

    def test_litellm_client_preserves_temperature_for_gpt51_models(self) -> None:
        client = LiteLLMGenerationClient(model="openai/gpt-5.1", api_key="test-key")
        mocked_response = {"choices": [{"message": {"content": "Answer"}}]}
